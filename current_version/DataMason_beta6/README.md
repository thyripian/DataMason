...
This package is currently in Beta release. While the main functionality is stable, some features (such as the unit tests) are still being tested and refined. Feedback and contributions are welcome!
